...
Partial Class MAdministrador_CargarAsignacion
                ...
                Else
                    ...
                    For Each singleFile In allFiles
                        ...
                        Else
                            ...
                            sw.WriteLine("TMP_PR_MC_USUARIO,")
                            sw.WriteLine("TMP_PR_MC_INSTANCIA")
                            sw.WriteLine(")")
                            sw.Close()
                            fs.Close()
                            ...
                            Dim V_Instancia As String = ""
                            If DdltipoAsig.SelectedValue = "Archivo" Then
                                Try
                                    V_Usuario = DdlUsuarioA.SelectedValue.ToString
                                Catch ex As Exception
                                    V_Usuario = ""
                                End Try
                                V_Instancia = DdlInstanciaA.SelectedValue
                            End If
                            Dim SSCommand2 As New SqlCommand("SP_CARGA_TMP_ACTSALDOS")
                            ...
                            SSCommand2.Parameters.Add("@V_INSTANCIA", SqlDbType.NVarChar).Value = V_Instancia
                            SSCommand2.Parameters.Add("@V_USUARIO", SqlDbType.NVarChar).Value = V_Usuario
                            SSCommand2.Parameters.Add("@V_TIPO", SqlDbType.NVarChar).Value = DdltipoAsig.SelectedValue
                            SSCommand2.Parameters.Add("@V_VALOR", SqlDbType.NVarChar).Value = (CType(Session("USUARIOADMIN"), USUARIO)).CAT_LO_CADENAAGENCIAS
                            SSCommand2.Parameters.Add("@V_USUARIO_CARGA", SqlDbType.NVarChar).Value = (CType(Session("USUARIOADMIN"), USUARIO)).CAT_LO_USUARIO
                            Dim DtsCarga As DataTable = Consulta_Procedure(SSCommand2, "SP_CARGAR_ASIGNACION")
                            ...
                            'Safi_actualizaAsignacionCartera(DtsCarga.Tables(1))
    ...
    Protected Sub BtnAcptar_Click(sender As Object, e As EventArgs) Handles BtnAcptar.Click
        ...
        Else
            ...
            Dim SSCommand As New SqlCommand("SP_CARGAR_ASIGNACION_V2")
            SSCommand.CommandType = CommandType.StoredProcedure
            SSCommand.Parameters.Add("@V_AGENCIA", SqlDbType.NVarChar).Value = (CType(Session("USUARIOADMIN"), USUARIO)).CAT_LO_AGENCIA
            SSCommand.Parameters.Add("@V_INSTANCIA", SqlDbType.NVarChar).Value = DdlInstanciaC.SelectedValue
