<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Accion.ascx.vb" Inherits="M_Administrador_grids_Codigos_Accion" %>
<div class="text-center">
    <h2>Configurar Código de Acción</h2>
    <p class="text-muted">Agregar / Editar Código de Acción</p>
        ...
        <fieldset>
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 my-2">
                    ...
                    <telerik:RadTextBox runat="server" ID="txtCod" Width="100%" EmptyMessage="Código de Acción" MaxLength="6" Text='<%# Eval("Codigo") %>'></telerik:RadTextBox>
                </div>
                <div class="col-12 col-md-6 my-2">
