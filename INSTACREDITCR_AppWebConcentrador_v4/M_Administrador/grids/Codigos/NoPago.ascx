<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NoPago.ascx.vb" Inherits="M_Administrador_grids_Codigos_NoPago" %>
<div class="text-center">
    <h2>Configurar Código de No Pago</h2>
    <p class="text-muted">Agregar / Editar Código de No Pago</p>
        ...
        <fieldset>
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 my-2">
                    <span>Código de Acción *</span>
                    <telerik:RadTextBox runat="server" ID="txtCod" Width="100%" EmptyMessage="Código de Acción" MaxLength="2" Text='<%# Eval("Codigo") %>'></telerik:RadTextBox>
                </div>
                <div class="col-12 col-md-6 my-2">
