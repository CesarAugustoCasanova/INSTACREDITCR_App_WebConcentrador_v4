<%@ Page Title="" Language="VB" MasterPageFile="~/M_Administrador/MasterPage.master" AutoEventWireup="false" CodeFile="PrioridadReglas.aspx.vb" Inherits="M_Administrador_PrioridadReglas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMaster" Runat="Server">
    ...
    <telerik:RadAjaxPanel ID="UPNLGeneral" runat="server" UpdatePanelCssClass="w3-center" CssClass="w3-center" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <div class="w3-container Titulos">
            <b>Prioridad de reglas de asignación</b>
        </div>
            <label> ID-MC | CONDICION(ES) | USUARIO(S) | PRIORIDAD  </label>
