...
Partial Class CargaBlockCuentas
    ...
    Dim Ruta As String = StrRuta() & "BlockCta\"

    Protected Sub BtnCargar_Click(sender As Object, e As EventArgs) Handles BtnCargar.Click
        Try
            ' If DdlDelimitador.SelectedValue <> "Seleccione" Then
            If DdlTipo.SelectedValue <> "Seleccione" Then
                ...
                Else
                    ...
                    For Each singleFile In allFiles
                        ...
                        Else
                            Dim TABLA As String = "TMP_BLACK_LIST_CREDITO"
                            ...
                            If (num <> 0) Then
                                ...
                                End If
                            Else
                                Dim SSCommand2 As New SqlCommand("SP_CARGAR_BLACK_LIST_CREDITO")
                                ...
                                Dim DtsCarga As DataTable = Consulta_Procedure(SSCommand2, "SP_CARGAR_BLACK_LIST_CTA")
                                GvCargaCta.DataSource = DtsCarga
                                GvCargaCta.DataBind()
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("USUARIOADMIN") IsNot Nothing Then
            ...
            If CType(Session("USUARIOADMIN"), USUARIO).CAT_LO_MADMINISTRADOR.ToString.Substring(21, 1) = 0 Then
    ...
    Private Sub SendMail(ByRef evento As String, ByVal ex As Exception, ByVal Cuenta As String, ByVal Captura As String, ByVal usr As String)
        EnviarCorreo("Administrador", "CargaBlockCuentas.aspx", evento, ex, Cuenta, Captura, usr)
    End Sub
