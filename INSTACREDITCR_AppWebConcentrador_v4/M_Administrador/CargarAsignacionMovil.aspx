<%@ Page Title="" Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="CargarAsignacionMovil.aspx.vb" Inherits="MAdministrador_CargarAsignacionMovil" %>
                ...
                <td class="LblDesc">
                    <telerik:RadComboBox ID="DdltipoAsig" runat="server" AutoPostBack="True" Culture="es-ES" EmptyMessage="Selecciona un tipo de asignación" Width="400px">
                        <Items>
                            ...
                            <%--<telerik:RadComboBoxItem runat="server" Text="De Usuario A Usuario" Value="De Usuario A Usuario" />--%>
                            <telerik:RadComboBoxItem runat="server" Text="Archivo" Value="Archivo" />
                        </Items>
                    </telerik:RadComboBox>
                </td>
            </tr>
