...
Imports System.Data
Public Class Class_GastosJudiciales
    Public Shared Function LlenarElementos(ByVal V_Valor1 As String, ByVal V_Valor2 As String, ByVal V_Valor3 As String, ByVal V_Valor4 As String, ByVal V_Bandera As String) As Object
        dim SSCommand as new sqlcommand
        SSCommand.CommandText = "SP_VARIOS_GASTOS_JUDICIALES"
