...
Public Class Funciones
    ...
    Public Shared Function TableToDictionary(ByVal tabla As DataTable) As IDictionary
        ...
        Return dict
    End Function
    Public Shared Sub EnviarCorreo(ByVal portal As String, ByVal Pantalla As String, ByVal Evento As String, ByVal ex As Exception, ByVal Mgcta As String, ByVal Captura As String, ByVal usr As String)

        Dim SSCommand As New SqlCommand("SP_ENVIAR_CORREO")
        SSCommand.CommandType = CommandType.StoredProcedure
        SSCommand.Parameters.Add("@v_Subject", SqlDbType.NVarChar).Value = portal
    ...
    'Public Shared Sub EnviarCorreo(ByVal portal As String, ByVal Pantalla As String, ByVal Evento As String, ByVal ex As String, ByVal Mgcta As String, ByVal Captura As String, ByVal usr As String)
    '    Dim SSCommand As New SqlCommand("SP_ENVIAR_CORREO")
    '    SSCommand.CommandType = CommandType.StoredProcedure
    '    SSCommand.Parameters.Add("@v_Subject", SqlDbType.NVarChar).Value = portal
    '    SSCommand.Parameters.Add("@V_Pantalla", SqlDbType.NVarChar).Value = Pantalla
    ...
    Public Shared Sub EnviarCorreoSinEx(ByVal portal As String, ByVal Pantalla As String, ByVal Evento As String, ByVal ex As String, ByVal Mgcta As String, ByVal Captura As String, ByVal usr As String)
        Dim SSCommand As New SqlCommand("SP_ENVIAR_CORREO")
        SSCommand.CommandType = CommandType.StoredProcedure
        SSCommand.Parameters.Add("@v_Subject", SqlDbType.NVarChar).Value = portal
        SSCommand.Parameters.Add("@V_Pantalla", SqlDbType.NVarChar).Value = Pantalla
    ...
    Public Shared Sub OffLine(ByVal Usuario As String)
        If Usuario <> "" Then
            ...
            SSCommand.Parameters.Add("@V_CAMPANA", SqlDbType.NVarChar).Value = "Milla"
            ...
            DtsVariable = Consulta_Procedure(SSCommand, SSCommand.CommandText)
        End If
    End Sub

    Public Shared Sub AUDITORIA(ByVal portal As String, ByVal USUARIO As String, ByVal MODULO As String, ByVal PAGINA As String, ByVal CREDITO As String, ByVal EVENTO As String, ByVal VALOR As String, ByVal IPPUBLICA As String, ByVal IPPRIVADA As String, ByVal V_ID_Session As String)
        Dim DtsDisponibles As DataTable = Class_Sesion.LlenarElementos(USUARIO, "", portal, "Cierre De Sesion Manual", 5, "", "", "Cierre De Sesion", V_ID_Session)
    End Sub
    ...
    Public Shared Function to_money(ByRef numero As String) As String
        Dim num As String = numero.Replace(",", "").Replace("$", "").Replace(" ", "")
        Dim valor As Double = CDbl(Val(num))
        to_money = "$ " & (valor.ToString("N", CultureInfo.InvariantCulture))
        Return to_money
    End Function

    Public Shared Function No_Money(ByRef numero As String) As String
    ...
    Public Shared Function ValidaLicencias(ByVal Cuantas As Integer, ByVal Usuario As String, ByVal Ip As String, ByVal Hora As String, ByVal V_bandera As Integer, ByVal V_ID_Session As String) As Integer
        Try
            ...
            ElseIf V_bandera = 4 Then 'Desconectar
                Dim DtsDisponibles As DataTable = Class_Sesion.LlenarElementos(Usuario, "Patrimonio", "Gestion", "Cierre De Sesion Manual", 5, "", Ip, "Cierre De Sesion", V_ID_Session)
                Return 0
            End If
    ...
    Public Shared Sub showModal(ByRef Notificacion As Object, ByVal icono As String, ByVal titulo As String, ByVal msg As String)
        ...
        radnot.Title = titulo
        radnot.Text = msg.Replace(Chr(10), "").Replace(Chr(13), "").Replace("'", "").Replace("""", "")
        radnot.Show()
    End Sub
