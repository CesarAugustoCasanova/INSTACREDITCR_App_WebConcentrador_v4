...
(function(window, undefined){
	...
	function contextMenuMio(opts)
	{
		...
		if ( opts.map !== undefined )
		{
			...
			this.theMenu = $(document.createElement('div'))
				.attr('class', 'contextMenuMio')

				// .. disable the browser context menu on our context menu
				.bind('contextMenuMio', function () { return false; })
	 ...
	 */
	contextMenuMio.prototype.addItem = function (name, loc, callback)
	{
	 ...
	 * @return jQuery The list item that is created.
	 */
	contextMenuMio.prototype.addSep = function (loc)
	{
	 ...
	 */
	contextMenuMio.prototype.remove = function (item)
	{
	...
	window.contextMenuMio = contextMenuMio;
